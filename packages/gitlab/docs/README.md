...
| gitlab.production.cpu_duration | Total time spent on CPU | long |
| gitlab.production.db_duration | Total time to retrieve data from PostgreSQL | long |
| gitlab.production.exception.class | The class that threw the exception | keyword |
| gitlab.production.exception.message | The exception message | keyword |
| gitlab.production.exception.stack_trace | The exception stack trace | keyword |
| gitlab.production.format | The format | keyword |
| gitlab.production.gitaly.calls | Total number of calls made to Gitaly | long |
| gitlab.production.gitaly.duration | Total time by Gitaly calls | long |
| gitlab.production.queue_duration | Total time the request was queued inside GitLab Workhorse | long |
| gitlab.production.redis.calls | Total number of calls made to Redis | long |
| gitlab.production.redis.duration | Total time to retrieve data from Redis | long |
| gitlab.production.redis.read_bytes | Total bytes read from Redis | long |
| gitlab.production.redis.write_bytes | Total bytes written to Redis | long |
| gitlab.production.view_duration | Total time inside the Rails views | long |
...
| event.module | Event module | constant_keyword |
| event.type | This is one of four ECS Categorization Fields, and indicates the third level in the ECS category hierarchy. `event.type` represents a categorization "sub-bucket" that, when used along with the `event.category` field values, enables filtering events down to a level appropriate for single visualization. This field is an array. This will allow proper categorization of some events that fall in multiple event types. | keyword |
| gitlab.application.caller_id | The controller and route that handled the request | keyword |
| gitlab.application.client_id | Client ID | keyword |
| gitlab.application.feature_category | Feature category | keyword |
| gitlab.application.jid | The job ID | keyword |
| gitlab.application.job_status | The status of the background job | keyword |
...
| event.module | Event module | constant_keyword |
| event.type | This is one of four ECS Categorization Fields, and indicates the third level in the ECS category hierarchy. `event.type` represents a categorization "sub-bucket" that, when used along with the `event.category` field values, enables filtering events down to a level appropriate for single visualization. This field is an array. This will allow proper categorization of some events that fall in multiple event types. | keyword |
| gitlab.api.cpu_duration | Total time spent on CPU | long |
| gitlab.api.db_duration | Total time to retrieve data from PostgreSQL | long |
| gitlab.api.exception.class | The class that threw the exception | keyword |
| gitlab.api.exception.message | The exception message | keyword |
| gitlab.api.exception.stack_trace | The exception stack trace | keyword |
| gitlab.api.gitaly.calls | Total number of calls made to Gitaly | long |
| gitlab.api.gitaly.duration | Total time by Gitaly calls | long |
| gitlab.api.queue_duration | Total time the request was queued inside GitLab Workhorse | long |
| gitlab.api.redis.calls | Total number of calls made to Redis | long |
| gitlab.api.redis.duration | Total time to retrieve data from Redis | long |
| gitlab.api.redis.read_bytes | Total bytes read from Redis | long |
| gitlab.api.redis.write_bytes | Total bytes written to Redis | long |
